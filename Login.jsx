  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: `radial-gradient(1200px 500px at 50% -10%, #ffffff 0%, ${C.paper} 65%)`, fontFamily: "'IBM Plex Sans', sans-serif" }}>
      <div className="w-full max-w-sm rounded-3xl p-8 shadow-xl condica-fade" style={{ backgroundColor: C.surface, border: `1px solid ${C.line}` }}>
        ...
        <h1 className="text-lg font-semibold text-center mb-1" style={{ color: C.text, fontFamily: "'Fraunces', serif" }}>Autentificare cabinet</h1>
        <p className="text-xs text-center mb-6" style={{ color: C.textSoft }}>Acces doar pentru personalul cabinetului.</p>
        ...
        <form onSubmit={submit}>
          ...
          <label className="block mb-4">
            <span className="block text-xs font-medium mb-1" style={{ color: C.textSoft }}>Parolă</span>
        ...
        <p className="text-[11px] text-center mt-5" style={{ color: C.textSoft }}>
          Nu ai încă un cont? <a href="/preturi" style={{ color: C.violet, fontWeight: 500 }}>Vezi planurile și abonează-te</a>.
        </p>
      </div>
    </div>
  );
