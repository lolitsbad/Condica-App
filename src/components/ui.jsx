...
import { X, Check, Copy, CheckCircle2, AlertCircle, XCircle, UserX, Globe, Sparkles } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(27,43,75,0.45)' }}>
      <div className={`w-full ${wide ? 'max-w-lg' : 'max-w-md'} rounded-2xl shadow-2xl p-6 max-h-[90vh] overflow-y-auto condica-fade`} style={{ backgroundColor: C.paper, border: `1px solid ${C.line}` }}>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold" style={{ color: C.ink, fontFamily: "'Fraunces', serif" }}>{title}</h3>
...
export const inputStyle = { width: '100%', padding: '8px 10px', borderRadius: '10px', border: `1px solid ${C.line}`, backgroundColor: '#fff', color: C.ink, fontSize: '14px', outline: 'none' };
