...
const PLANS = [
  {
    id: 'solo', name: 'Solo', price: '2.900 RON', period: 'o dată', maintenance: '+ 49 RON/lună mentenanță',
    features: ['1 medic', 'Programări + calendar vizual', 'Pagină publică de rezervare', 'Pacienți', 'Asistent AI (100 acțiuni/lună)', 'Facturare'],
  },
  {
    id: 'cabinet', name: 'Cabinet', price: '5.900 RON', period: 'o dată', maintenance: '+ 89 RON/lună mentenanță', highlight: true,
